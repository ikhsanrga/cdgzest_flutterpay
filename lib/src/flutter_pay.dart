...
class FlutterPay {
  ...
  /// See [PaymentNetwork].
  /// * Please specify [allowedPaymentNetworks] when invoke
  /// [canMakePaymentsWithActiveCard] function before invoking this
  /// [requestPayment] function to avoid overlay issue during back button press
  ///
  ...
  Future<String> requestPayment({
    @required GoogleParameters googleParameters,
    @required AppleParameters appleParameters,
